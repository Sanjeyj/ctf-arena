...
def upgrade():
    ...
    with op.batch_alter_table('certificates', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_certificates_course_id', 'lms_courses', ['course_id'], ['id'], ondelete='SET NULL')
        batch_op.create_foreign_key('fk_certificates_organization_id', 'organizations', ['organization_id'], ['id'], ondelete='SET NULL')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('certificates', schema=None) as batch_op:
        batch_op.drop_constraint('fk_certificates_course_id', type_='foreignkey')
        batch_op.drop_constraint('fk_certificates_organization_id', type_='foreignkey')
